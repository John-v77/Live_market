defmodule LiveMarketWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveMarketWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveMarketWeb.Gettext, "errors", msg, opts)
    end
  end
